        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-10">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><ReactRouterDOM.Link to="/terms" className="text-sm hover:text-brand-accent dark:hover:text-brand-accent-dark transition-colors">Terms of Service</ReactRouterDOM.Link></li>
              <li><ReactRouterDOM.Link to="/privacy" className="text-sm hover:text-brand-accent dark:hover:text-brand-accent-dark transition-colors">Privacy Policy</ReactRouterDOM.Link></li>
            </ul>
          </div>
